                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-md-6 user_image_box">
                        ...
                        <a href="#" data-toggle="modal" data-target="#photo-library">
                            <img class="img-responsive" src="<?php echo $user->image_path_and_placeholder();  ?>" alt="photo">
                        </a>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control" autocomplete="new-password" value="<?php echo $user->password; ?>">
                            </div>
